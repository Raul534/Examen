...
public class ElementoPartido1X2 {
	...
	/**
	 * Constructor que nos permite crear un partido con sus resultados
	 * @param equipoLocal nombre del equipo local
	 * @param equipoVisitante nombre del equipo visitante
	 */
	public ElementoPartido1X2(String equipoLocal, String equipoVisitante) {
	 ...
	 * @throws Partido1X2Exception excepcion que indica que no hay partidos
	 */
	 ...
	 * {@link Partido1X2Exception} en caso contrario.
	 * @throws Partido1X2Exception Excepcion que indica que no caben mas partidos
	 */
	 ...
	 * @throws Partido1X2Exception excepcion que salta si esta mal formado el csv
	 */
